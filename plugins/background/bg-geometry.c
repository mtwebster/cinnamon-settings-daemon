...
BgRect
bg_geometry_image_rect (CinnamonBgPlacement mode,
                        int src_w, int src_h,
                        ...
                        int span_total_w, int span_total_h)
{
    ...
    switch (mode) {
    case CINNAMON_BG_PLACEMENT_STRETCHED:
        r.w = span_total_w;
        r.h = span_total_h;
        break;
    case CINNAMON_BG_PLACEMENT_CENTERED:
        r.w = src_w;
        r.h = src_h;
        break;
    case CINNAMON_BG_PLACEMENT_SCALED: {
    ...
    case CINNAMON_BG_PLACEMENT_ZOOM: {
    ...
    case CINNAMON_BG_PLACEMENT_NONE:
    case CINNAMON_BG_PLACEMENT_WALLPAPER:
        return r;
    }
