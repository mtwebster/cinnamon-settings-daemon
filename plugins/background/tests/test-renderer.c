...
test_solid_fills (void)
{
    ...
    BgRenderInput in = { CINNAMON_BG_PLACEMENT_NONE, CINNAMON_BG_SHADING_SOLID,
                         { 1, 0, 0, 1 }, { 0, 0, 0, 1 }, NULL };
...
test_horizontal_gradient_direction (void)
{
    cairo_surface_t *s = cairo_image_surface_create (CAIRO_FORMAT_ARGB32, 64, 64);
    cairo_t *cr = cairo_create (s);
    BgRenderInput in = { CINNAMON_BG_PLACEMENT_NONE, CINNAMON_BG_SHADING_HORIZONTAL,
